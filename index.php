        ...
        <div class="container">
          <div class="collapse navbar-collapse offset" style="margin-left: -150px;" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav ml-auto">
              ...
              <li class="nav-item active nav-link float: right;"><a class="navbar-brand logo_h" href="#home"><div style="color: white;">
                <img src="img/logo.png" alt="" height="55">&nbsp;&nbsp;SMKN 7 BALEENDAH
              </div>
              </a></li>
        ...
        <section class="download_app_area p_120" id="contact">
          <div class="container">
            <div class="app_inner">
              <h2>Contact</h2>
              <p>
                Saran dan masukan Anda sangat berarti untuk Kami<br>Hubungi kami untuk info lebih lanjut!
              </p>
          ...
          <div class="container">
            <div class="row footer-bottom d-flex justify-content-between align-items-center">
              <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                All rights reserved | SMKN 7 Baleendah
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              </p>
