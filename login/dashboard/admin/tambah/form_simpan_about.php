...
<body>
	<br><br>
	<div class="kotak2">
	<center><h3>Tambah About</h3></center>
	<form method="post" action="proses_simpan_about.php" enctype="multipart/form-data">
		<table cellpadding="8">
			<tr>
				<td>Judul</td>
		...
		<a href="../index.php?menu=info"><input type="button" value="Batal" class="tombol_batal"></a>
	</form>
</div>
</body>
</html>