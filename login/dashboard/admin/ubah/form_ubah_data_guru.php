...
<body>
 ...
 ?>
<div class="kotak">
	<center><h3>Ubah Data guru</h3></center>
	<form method="post" action="proses_ubah_data_guru.php?kode=<?= $kode ?>;" enctype="multipart/form-data">
		<table cellpadding="8">
			<tr>
				<td>Id</td>
		...
		<a href="../index.php?menu=data_guru">
