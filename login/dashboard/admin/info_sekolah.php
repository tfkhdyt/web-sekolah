...
<table width="100%" cellspacing="0" cellpadding="5">
  ...
  while ($data = mysqli_fetch_array($sql)): ?>
				...
				<td valign="top" align="center" width="180px"><a href="ubah/form_ubah_selayang.php?id=<?= $data[
      "id"
    ] ?> "><button class="tombol_ubah">Ubah</button></a></td>
			<?php endwhile;
  ?>
</table>
...
<table width="100%" cellspacing="0" cellpadding="5">
  ...
  while ($data = mysqli_fetch_array($sql)): ?>
				...
				<td valign="top" align="center" width="180px"><a href="ubah/form_ubah_about.php?id=<?= $data[
      "id"
    ] ?> "><button class="tombol_ubah">Ubah</button></a>&nbsp;<a href="hapus/proses_hapus_about.php?id=<?= $data[
   "id"
...
<p style="font-size: 15pt; margin: 10px 0 5px 260px;">Profil Sekolah</p><br>
 ...
 ?>
  	<a href="ubah/form_ubah_profil.php?id=<?= $data[
     "id"
   ] ?> "><button class="tombol_ubah" style="margin: -50px 0 10px 260px;">Ubah</button></a>
...
<table width="100%" cellspacing="0" cellpadding="5">
  ...
  while ($data = mysqli_fetch_array($sql)): ?>
				...
				<td><?= $data["email"] ?></td>
				<td><?= $data["telepon"] ?></td>
				<td align="center" width="180px"><a href="ubah/form_ubah_kontak.php?id=<?= $data[
      "id"
    ] ?> "><button class="tombol_ubah">Ubah</button></a></td>
			<?php endwhile;
  ?>
