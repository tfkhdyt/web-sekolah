...
<table width="100%" cellspacing="0">
  ...
  while ($data = mysqli_fetch_array($sql)): ?>
      ...
      "foto"
				...
				<td align="center" width="180px"><a href="ubah/form_ubah_data_siswa.php?kode=<?= $data[
      "kode"
    ] ?> "><button class="tombol_ubah">Ubah</button></a>&nbsp;<a href="hapus/proses_hapus_data_siswa.php?kode=<?= $data[
   "kode"
